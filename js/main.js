...
timeBtns.forEach((timeBtn)=>{
    timeBtn.addEventListener('click',(e)=>{
        ...
        window.localStorage.setItem("sCount",e.currentTarget.dataset.time)
...
// let qCount= window.localStorage.getItem("qCount");
function getQuestions(){
    ...
    myRequest.onreadystatechange =function(){
        if(this.readyState === 4 && this.status === 200){
            ...
            let qCount= window.localStorage.getItem("sCount")
